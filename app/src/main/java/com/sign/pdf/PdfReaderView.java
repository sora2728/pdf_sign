...
public class PdfReaderView extends AdapterView<Adapter>
...
//		Log.d("ReaderView","cvLeft：:"+String.valueOf(cvLeft));
        ...
        int pianyizhi = height - this.getHeight();
        ...
        if (cv.getY() > 0) {
            scrollY = -(int) (height - cv.getY() - cv.getHeight() - pianyizhi);
        } else {
            scrollY = cvBottom - height + pianyizhi;
        }
        invalidate();
    }
    ...
    private void measureView(View v) {
        ...
        v.measure(MeasureSpec.EXACTLY | (int) (v.getMeasuredWidth() * scale * getmScale()),
                MeasureSpec.EXACTLY | (int) (v.getMeasuredHeight() * scale * getmScale()));
    }
